...
class ResetDemoUser extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:reset-demo-user';
     ...
     * @var string
     */
    protected $description = 'Delete and recreate the demo user';
    ...
    public function handle()
    {
        ...
        // Delete only the demo user and their related data
        $demoUser = User::where('email', $email)->first();
        if ($demoUser) {
            // Optional: delete demo user's notes/tags if necessary
            $demoUser->notes()->delete();
        ...
        $notesData = [
            [
                ...
                'lastEdited' => '2024-10-29 10:15:00',
                'archived' => false
            ],
            [
                ...
                'lastEdited' => '2024-10-28 16:45:00',
                'archived' => false
            ],
            [
                ...
                'lastEdited' => '2024-10-27 14:30:00',
                'archived' => false
            ],
            [
                ...
                'lastEdited' => '2024-10-26 09:20:00',
                'archived' => true
            ],
            [
                ...
                'lastEdited' => '2024-10-25 18:10:00',
                'archived' => false
            ],
            [
                'title' => 'Gift Ideas',
                ...
                'lastEdited' => '2024-10-20 11:30:15',
                'archived' => true
            ],
            [
                ...
                'lastEdited' => '2024-10-15 14:23:45',
                'archived' => true
            ],
            [
                ...
                'lastEdited' => '2024-10-12 09:45:15',
                'archived' => false
            ],
            [
                'title' => 'Reading List',
                ...
                'lastEdited' => '2024-10-05 12:20:30',
                'archived' => false
            ],
            [
                ...
                'lastEdited' => '2024-09-22 07:30:00',
                'archived' => false
            ],
        ];

        // Build tag map to avoid duplicate tags
        $uniqueTags = collect($notesData)->pluck('tags')->flatten()->unique();
        $tagMap = collect();

        foreach ($uniqueTags as $tagName) {
            $tag = $user->tags()->create(['name' => $tagName]);
        ...
        foreach ($notesData as $noteData) {
            $note = $user->notes()->create([
                ...
                'created_at' => $noteData['lastEdited'],
                'updated_at' => $noteData['lastEdited'],
            ]);

            $note->tags()->attach(collect($noteData['tags'])->map(fn($tag) => $tagMap[$tag]));
        }

        $this->info('Demo user reset with seed data completed.');
    }
}
