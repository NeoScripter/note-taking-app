...
export default function ErrorField({ children }: ErrorFieldProps) {
    return (
        <Description className="mt-1 inline-flex items-center gap-2 text-xs text-red-600">
            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M8.0038 10.9621V8.09573M8 6.0695V6.02734" stroke="#FB3748" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            {children}
        </Description>
    );
