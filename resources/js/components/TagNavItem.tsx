...
export default function TagNavItem({ routeName, children, label }: TagNavItemProps) {
    ...
    return (
        <li>
            <Link href={route(routeName)} className={clsx("flex items-center gap-2 border-b border-gray-200 py-3 text-sm md:border-none md:px-3 md:rounded-lg", isCurrent && 'text-primary-blue bg-gray-neutral')}>
                {children}
